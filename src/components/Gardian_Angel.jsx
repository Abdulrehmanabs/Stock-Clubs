    ...
    <div className="bg-[#FBBC12] px-6 sm:py-20 py-10 relative overflow-hidden">
      ...
      <div className=" bg-white sticky z-20 rounded-2xl px-10 sm:px-20 py-8 flex justify-center items-center flex-wrap max-w-screen-2xl mx-auto">
        <div className="relative w-full lg:w-3/5  order-1 lg:order-2 text-center">
          <h2 className="absolute bg-slate-50 top-0 z-0 left-0 right-0 max-w-[450px] w-[90%] h-full lg:h-[120%] lg:-mt-14 rounded-3xl py-6 mx-auto text-center text-3xl font-semibold">
            Gardian Angels
          </h2>
          <img
            className="mx-auto hover:scale-105  sticky sm:my-4 my-2 mt-20 lg:mt-6 z-40 duration-700"
            src={Amazonians}
          ...
          <input
            type="text"
            className="mx-auto bg-[#3994E9] p-4 my-2 rounded-lg focus:outline-none max-w-[450px] w-[80%] sticky z-40"
          />
          <br />
          <button className="bg-[#3994E9] text-white my-4 p-4 sticky z-40">
            Submit
          </button>
        </div>
